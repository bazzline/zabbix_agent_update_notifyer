...
PATH_TO_SYSTEMD_SERVICE_FILE="${ROOT_PATH_TO_PACKAGE_CONFIGURATION}/zabbix_agent-update_notifyer.service"
PATH_TO_SYSTEMD_TIMER_FILE="${ROOT_PATH_TO_PACKAGE_CONFIGURATION}/zabbix_agent-update_notifyer.timer"
